...
class _PexelsApiService implements PexelsApiService {
  _PexelsApiService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<PexelsVideoResponse> getPopularVideos(
    ...
    final _options = _setStreamType<PexelsVideoResponse>(
    ...
    late PexelsVideoResponse _value;
    try {
      _value = PexelsVideoResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
